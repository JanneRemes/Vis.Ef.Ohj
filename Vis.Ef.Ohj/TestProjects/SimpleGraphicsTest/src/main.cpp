...
void changeCurrentScene(int index)
{
	...
	switch( index )
	{
	case 0: m_currentScene = new QuadScene(); break;
	case 1: m_currentScene = new QuadShaderScene(); break;
	case 2: m_currentScene = new TriangleScene(); break;
...
int main ( int argc, char *argv[] )
{
	...
	graphics::esCreateWindow(&esContext, 1920 * 0.9, 1200 * 0.9, graphics::ES_WINDOW_DEFAULT);
